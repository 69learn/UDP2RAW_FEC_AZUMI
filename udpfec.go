...
var downlURLs = map[string]map[string]string{
	"udp2raw": {
		"amd64": "https://github.com/69learn/udp2rawmain/releases/download/latest/udp2raw_amd64",
		"arm64": "https://github.com/69learn/udp2rawmain/releases/download/latest/udp2raw_arm",
	},
	"udpspeed": {
		"amd64": "https://github.com/69learn/udp2rawmain/releases/download/speed/speederv2_amd64",
		"arm64": "https://github.com/69learn/udp2rawmain/releases/download/speed/speederv2_arm",
	},
}
